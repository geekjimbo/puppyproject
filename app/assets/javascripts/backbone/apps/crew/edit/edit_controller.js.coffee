@RJ.module "CrewApp.Edit", (Edit, App, Backbone, Marionette, $, _) ->
	...
	class Edit.Controller extends App.Controllers.Base
		...
		formRegion: (crew) ->
			...
			@listenTo editView, "city:changed", (model, value, options) ->
				console.log model
		...
		App.reqres.setHandler "city:crew", (city_id, options={}) ->
			console.log city_id
			console.log $(this.el)
